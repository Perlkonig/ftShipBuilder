...
-   Core systems icon no longer missing from the block-based layout assembled SSD (corrected SVG symbol reference after the ftlibship migration).
...
-   There were situations where the cell size value could not be changed in the freeform layout. This is now hopefully corrected. (Thank you, @Bk2O7 for reporting.)
